  ...
  const handleRun = async () => {
    ...
    try {
      ...
      formData.append("config", JSON.stringify({
        ...
        ragas_metrics: cfg.ragas_metrics,
        deepeval_metrics: cfg.deepeval_metrics,
        use_geval: cfg.use_geval,
        deployment_type: cfg.deployment_type,
        vector_db: cfg.vector_db,
        session_db: cfg.session_db,
        cache_layer: cfg.cache_layer,
        message_queue: cfg.message_queue,
        api_gateway: cfg.api_gateway,
        auth_mechanism: cfg.auth_mechanism,
        monitoring_tool: cfg.monitoring_tool,
        is_multi_region: cfg.is_multi_region,
        has_rate_limiting: cfg.has_rate_limiting,
        has_retry_logic: cfg.has_retry_logic,
        has_circuit_breaker: cfg.has_circuit_breaker,
        has_caching: cfg.has_caching,
        has_dlq: cfg.has_dlq,
